            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <form action="/superadmin/peserta/show/{skpwajib}/storeW" method="POST" id="formInput">
                        @csrf
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                <label for="mahasiswa_fakultas" class="form-control-label">Fakultas</label>
                                <select name="mahasiswa_fakultas" class="selectpicker form-control" data-live-search="true">
                                    <option value="" selected="selected" disabled>- Pilih -</option>
                                        <option value="FTSP">FE</option>
                                        <option value="FTSP">FH</option>
                                        <option value="FTI">FTI</option>  
                                        <option value="FPSB">FPSB</option>
                                        <option value="FTSP">FTSP</option>
                                        <option value="FTSP">FMIPA</option>
                                        <option value="FTSP">FK</option>
                                        <option value="FTSP">FIAI</option>
                                </select>
                                </div>
                            </div>
                            <div class="col-3">
